...
export default function Calendar() {
  ...
  return (
    <>
      <main className='flex min-h-screen flex-col items-center justify-between p-24 text-textLight dark:text-textDark'>
        <div className='grid grid-cols-10'>
          <div className='col-span-8 calendar-wrapper'>
            <FullCalendar
